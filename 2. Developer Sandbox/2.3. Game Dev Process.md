...
5. Enter your game logic into dapp.logic.js file (the **play** function). Note that the file contains two mandatory functions: **play** and **customDataFormat**; the latter imports game data. 
